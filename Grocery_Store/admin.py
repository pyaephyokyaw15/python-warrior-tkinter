...
# Create Admin button
button1 = tkinter.Button(root,image=admin_logo, borderwidth=5, bg='#cadbc3', relief=tkinter.RIDGE )
...
button2 = tkinter.Button(root,image=employee_logo, borderwidth=5, bg='#cadbc3', relief=tkinter.RIDGE )
